...
///
/// The same fields as `bua_agent::manifest::Attempt`, flattened for the file. Kept as its own
...
impl StoredManifest {
    ...
    pub fn of(attempt: &bua_agent::manifest::Attempt, failure: Option<String>) -> Self {
        Self {
