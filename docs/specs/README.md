...
| [terminal-transcript.md](terminal-transcript.md) | `VIEW` | 17 | what is drawn back: the transcript, a resumed session, and how content reaches the screen |
| [watching.md](watching.md) | `WATCH` | 13 | a delegate's own work on the screen: where its lines go, and the mode Ctrl-L opens over them |
...
| [sessions.md](sessions.md) | `SESSION` | 15 | what is kept between runs: the record of a session, and the prompts a person typed |
...
| [tools/spawn-agent.md](tools/spawn-agent.md) | `AGENT` | 4 | `spawn_agent` |
