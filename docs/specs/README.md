...
| [terminal-input.md](terminal-input.md) | `INPUT` | 7 | what the user types into: the box, the keys, and where a terminal's own limits show through |
...
| [compaction.md](compaction.md) | `COMPACT` | 7 | shortening a long conversation into a summary of itself, in the request only |
| [sessions.md](sessions.md) | `SESSION` | 7 | what is kept between runs: the record of a session, and the prompts a person typed |
