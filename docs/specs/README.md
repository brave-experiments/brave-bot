...
| [terminal-input.md](terminal-input.md) | `INPUT` | 12 | what the user types into: the box, the keys, and where a terminal's own limits show through |
...
| [terminal-transcript.md](terminal-transcript.md) | `VIEW` | 8 | what is drawn back: the transcript, a resumed session, and how content reaches the screen |
